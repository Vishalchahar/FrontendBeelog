              ...
              <form>
                ...
                <div class="flex my-10 ">
                  <button
                    ...
                    class="inline-block px-7 py-3 bg-sky-300 text-white w-1/4 mx-6 font-medium text-s leading-snug rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                  >
