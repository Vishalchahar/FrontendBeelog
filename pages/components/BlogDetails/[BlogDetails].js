      ...
      <div className="container mx-auto">
        <div className="px-6 py-4">
          <div className="flex flex-row">
            ...
            />
            <div className="m-3 text-4xl">{blogContent.userName}</div>
          </div>
          <div className="m-3 text-5xl font-bold">{blogContent.title}</div>
          <div>
            <img
              ...
              alt="Sunset in the mountains"
            />
            <p className="ml-2 text-xl text-gray-700">{blogContent.content}</p>
          </div>
        </div>
        <div className="px-6 pt-4 pb-2">
          <button className="flex flex-row inline-block px-2 py-1 text-2xl font-semibold text-gray-700 bg-blue-200 rounded-full hover:bg-blue-400">
          ...
          {/* <span className="inline-block px-3 py-1 mb-2 mr-2 text-sm font-semibold text-gray-700 bg-gray-200 rounded-full"></span> */}
          {/* <span className="inline-block px-3 py-1 mb-2 mr-2 text-sm font-semibold text-gray-700 bg-gray-200 rounded-full"></span> */}
        </div>
      </div>
    </div>
